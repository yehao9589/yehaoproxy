...
CREATE TABLE IF NOT EXISTS product_offers (id TEXT PRIMARY KEY,product TEXT NOT NULL,region TEXT NOT NULL,region_name TEXT NOT NULL,billing_cycle TEXT NOT NULL DEFAULT 'fixed-days',price_7 REAL NOT NULL,price_30 REAL NOT NULL,price_90 REAL NOT NULL,price_180 REAL NOT NULL DEFAULT -1,sale_stock INTEGER NOT NULL DEFAULT 0,sold INTEGER NOT NULL DEFAULT 0,enabled INTEGER NOT NULL DEFAULT 1,sort_order INTEGER NOT NULL DEFAULT 100,created_at INTEGER NOT NULL,updated_at INTEGER NOT NULL);

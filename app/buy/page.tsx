...
export default function Buy() {
  ...
  return <main className="auth-page">
    <section className="auth-brand"><a className="brand" href="/"><span>Y</span> YehaoProxy</a><div><span className="kicker">ORDER REVIEW</span><h1>确认商品订单</h1><p>{isNode ? "节点订单付款后由管理员按地区和配置完成开通。" : "付款后由管理员分配资源并完成开通。"}</p></div></section>

...
const flagRegions = new Set(["US","GB","DE","JP","SG","HK"]);
function flagPath(region:string){const code=region.toUpperCase();return flagRegions.has(code)?`/flags/${code.toLowerCase()}.svg`:null}

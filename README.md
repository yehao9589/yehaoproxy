...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-v1.0.3-2563eb">
...
完整步骤请阅读 [部署指南](./DEPLOYMENT.md)。正式上线前请逐项完成 [v1.0.3 发布核对清单](./RELEASE_CHECKLIST.md)。

## 快速部署

宝塔 Compose、`.env`、数据库、首次安装、域名、备份、更新和故障排查步骤全部统一在 [部署指南](./DEPLOYMENT.md)。部署时只需要按照这一份文档操作。

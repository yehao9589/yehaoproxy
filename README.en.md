...
The Baota Compose, `.env`, database, first-time installation, domain, backup, update, and troubleshooting instructions are all maintained in the single [deployment guide](./DEPLOYMENT.md). Follow only that document when deploying.
